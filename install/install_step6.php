...
?>
<p>You have to enter/edit some settings now, i will generate a config based on this data for you.<br/>
...
You can try to get the needed corp/alliance id from the eve-dev.net test keyboard in case you don't know them.
</p>
...
{
?>
<tr><td width="120"><b><?php echo $set['descr']; ?></b></td><td><input type=text name=set[<?php echo $set['name']; ?>] size=60 maxlength=80 value="<?php echo $_SESSION['sett'][$set['name']]; ?>"></td></tr>
<?php
}
?>
