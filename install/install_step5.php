...
?>
<p>You can now search for your corporation/alliance.<br/>
If you haven't imported that data or your corporation/alliance is missing i will offer to create it for you.<br/>
<b>Note:</b> Make sure you spell your corporation/alliance correctly (including capitalization), else you cannot post any mails!<br/>
</p>
<?php
if ($stoppage)
{
...
{
    echo '<b>Warning:</b> It seems like i got no alliance and corpid, you can continue but you might have to edit it into the config yourself.<br/>';
}
?>
