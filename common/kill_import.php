...
$html .= "<form id=\"options\" name=\"options\" method=\"post\" action=\"?a=kill_import\">";
...
//                $_SESSION['kill_import']['p_all'] = $p_all;
    ...
    {
        $html .= '<meta http-equiv="refresh" content="5; URL=?a=kill_import" />';
        $html .= 'Automatic refresh in 5s<br/>';
        $html .= '<a href="?a=kill_import">Read next '.$_SESSION['kill_import']['num'].'</a>&nbsp;<a href="?a=kill_import&submit=Reset">Reset</a>';
    ...
    else
    {
        ...
        $html .= '<a href="?a=kill_import">Ok</a>';
        unset($_SESSION['kill_import']);
    }
}
