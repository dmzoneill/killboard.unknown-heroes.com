...
$html .= '<a href="http://www.eve-dev.net/" target="_blank"><img src="http://www.eve-dev.net/e107_images/evedev_button.png" border="0"/></a><br/><br/>';
...
if ($config->getConfig('ship_values'))
{
    ...
    while ($row = $qry->getRow())
    {
        ...
        {
            $row['shp_name'] = '<img src="'.IMG_URL.'/ships/32_32/t2.gif">'.$row['shp_name'];
        }
